  ...
  return (
    <div className="stats-section mt-[100px] w-[100%] flex justify-around items-center space-x-4">
      ...
      {cardData.map((card, index) => (
        <motion.div
          key={index}
          className="card gap-4 flex-wrap flex overflow-hidden items-center justify-around flex-col p-6 rounded-lg  text-center"
        //   whileHover={{ scale: 1.1 }}
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: index * 0.2 }}
        >
        <div  className=" h-[250px] bg-[#20234d]  rounded-full  gap-4 w-[250px]  flex flex-col justify-center items-center">
