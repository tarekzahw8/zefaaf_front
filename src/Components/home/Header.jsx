    ...
    <header className="w-[90%] max-md:w-[100%]  max-md:flex-col-reverse mx-auto  flex items-center justify-around">
      <div className="w-[65%] max-md:w-[100%]  flex flex-col items-start justify-around h-full max-md:h-fit p-8 max-md:p-1 ">
        <div className="flex flex-col justify-around  h-full  ">
          <h3 className={`${user != null? "text-[42px]":"text-[55px]"} max-md:text-[30px]  font-semibold`}>
            ابحث عن شريك حياتك بأخلاق إسلامية{" "}
          </h3>
          <p className="text-[16px]  pt-2 max-md:text-[14] font-medium">
            سواء كنت تبحث عن شريك يتوافق مع قيمك الإسلامية أو تسعى لبناء حياة
            زوجية مباركة، منصة زفاف توفر لك البيئة المثالية للعثور على الشخص
            المناسب بطريقة شرعية وآمنة. سجّل الآن وابدأ رحلتك نحو الزواج
            المبارك.
          </p>
