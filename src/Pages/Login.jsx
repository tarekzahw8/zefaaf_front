...
toast.error("حدث خطأ اثناء تسجيل الدخول")
 ...
 <div className="w-[80%] home_section bg-white rounded-[15px] h-fit   relative z-10 mt-[100px] flex items-start mx-auto justify-around">
 <section className="flex  flex-col w-[40%]  h-full  items-start ">
...
<div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <h2 className="text-center text-gray-700 font-bold mb-10 text-[35px]">تسجيل الدخول</h2>
